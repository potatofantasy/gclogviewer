...
{
    public TimingWindowData(int cpu_count)
    {
	_cpu_count = cpu_count;
    }

    public double th_alloc()
    {
	return _th_alloc;
    }
    ...
    public double concurrent_time()
    {
	return _concurrent_time;
    }
    ...
    public double elapsed_cpu_time()
    {
	return elapsed_time() * _cpu_count;
    }

    public double concurrent_cpu_time()
    {
	return _concurrent_cpu_time;
    }

    public double pause_cpu_time()
    {
	return _pause_time * _cpu_count;
    }

    public double mutator_cpu_time()
    {
	return (elapsed_time() - _pause_time) * _cpu_count - _concurrent_cpu_time;
    }
    ...
    public void add_concurrent_time(double end_timestamp, double t, int thread_cnt)
    {
	_end = end_timestamp;
	_concurrent_time += t;
