...
public class FWYoungGCParser extends GCParser
{
    ...
    // 0.246: [GC 0.246: [DefNew: 1403K->105K(1984K), 0.0109275 secs]
    // 1403K->1277K(6080K), 0.0110143 secs]
    private static Pattern _pattern = Pattern.compile(timestamp_re + "\\[GC " + timestamp_re + "\\[" + fw_young_gen_re + ": " + heap_report_re + "\\] " + heap_report_re + "\\]");
    ...
    private static final int th_used_beg_grp = yg_used_beg_grp + heap_report_re_groups;
