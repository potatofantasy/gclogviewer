...
{
    /* gc pauses */
    ygc_begin_time(1), ygc_time(1), fgc_time(1), cms_im_time(1), cms_rm_time(1), tgc_time(1),
    ...
    yg_used_end(2), yg_commit_beg(2), yg_commit_end(2), og_used_beg(1), /*
									 * old
									 * gen
									 * sizes
									 */
    og_used_end(2), og_commit_beg(2), og_commit_end(2), pg_used_beg(1), /*
									 * perm
									 * gen
									 * sizes
									 */
    pg_used_end(2), pg_commit_beg(2), pg_commit_end(2), th_used_beg(1), /*
									 * total
									 * heap
									 * sizes
									 */
    th_used_end(2), th_commit_beg(2), th_commit_end(2),

    /*
     * Need good, terse convention for naming rates:
     * 
     * r_cpu rate/sec of cpu time available r_ela rate/sec of elapsed time r_mut
     * rate/sec of cpu time available to mutators r_ygc rate/sec of young gc
     * time
     * 
    ...
    pc_pre_comp(1), pc_par_mark(1), pc_mark_flush(1), pc_ref_proc(1), pc_cls_unload(1), pc_mark(1), pc_summary(1), pc_adj_roots(1), pc_perm_gen(1), pc_drain_ts(1), pc_dpre_ts(1), pc_steal_ts(1), pc_par_comp(1), pc_deferred(1), pc_compact(1), pc_post_comp(1);
